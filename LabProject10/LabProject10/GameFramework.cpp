...
void GameFramework::BuildObjects(){
	...
	// 뷰포트 설정 및 생성
	// 그려질 x, 그려질 y, 그려질 가로 크기, 그려질 세로 크기, Minz, Maxz
	...
	// 투영 변환 행렬 설정 및 생성
	//  FarZ(근 평명), NearZ(원 평면), FovAngleY(종횡비), AspectRatio(FOV)
	...
	m_pCamera->GenerateViewMatrix(XMFLOAT3(125.0f, 500.0f, -250.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));
