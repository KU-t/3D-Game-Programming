...
void Scene::BuildObjects(ID3D12Device *pd3dDevice) {
	...
	pd3dDevice->CreateRootSignature(0, pd3dSignatureBlob->GetBufferPointer(), pd3dSignatureBlob->GetBufferSize(),
		__uuidof(ID3D12RootSignature), (void **)&m_pd3dGraphicsRootSignature); if (pd3dSignatureBlob) pd3dSignatureBlob->Release();
	...
	nCompileFlags = D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION; 
		...
		d3dRasterizerDesc.CullMode = D3D12_CULL_MODE_BACK; d3dRasterizerDesc.FrontCounterClockwise = FALSE;
