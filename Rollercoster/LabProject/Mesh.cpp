...
CRailMesh::CRailMesh() : CMesh(2){
	...
	CPolygon *plook = new CPolygon(4);
	plook->SetVertex(0, CVertex(-0.5, +0.7, +0));
	plook->SetVertex(1, CVertex(-0.25, +0.7, +0));
	plook->SetVertex(2, CVertex(-0.25, -0.7, +0));
	plook->SetVertex(3, CVertex(-0.5, -0.7, +0));
	SetPolygon(0, plook);

	CPolygon *pup = new CPolygon(4);
	pup->SetVertex(0, CVertex(0.5, +0.7, +0));
	pup->SetVertex(1, CVertex(0.25, +0.7, +0));
	pup->SetVertex(2, CVertex(0.25, -0.7, +0));
	pup->SetVertex(3, CVertex(0.5, -0.7, +0));
	SetPolygon(1, pup);
}
