...
//  용도: 창 클래스를 등록합니다.
//
ATOM MyRegisterClass(HINSTANCE hInstance)	// 1. 윈도우 클래스를 시스템에 등록
{
    WNDCLASSEXW wcex;
    ...
    wcex.lpfnWndProc    = WndProc; // 윈도우 프로시져를 설정
    wcex.cbClsExtra     = 0;
    wcex.cbWndExtra     = 0;
    ...
    wcex.lpszClassName  = szWindowClass; // 메뉴를 없애려면 = NULL;
...
//
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)	// 2. 윈도우 프로그램 초기화 및 주 윈도우 생성
{
